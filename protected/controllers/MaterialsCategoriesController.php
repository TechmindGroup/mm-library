...
class MaterialsCategoriesController extends Controller
{
	...
	public function actionCreate()
	{
		...
		{
			$model->attributes=$_POST['MaterialCategories'];
			if($model->save())
		...
		$this->render('create',array(
			'model'=>$model,
			'categoriesData'=>$model->getGroupArray()
		));
	}
	...
	public function actionUpdate($id)
	{
		...
		$criteria->addCondition('childCategories.id !='.$model->id);
		$criteria->params = array(':id'=>$model->id);
		$criteria->order = 't.parent_id ASC';
		$criteria->with = 'childCategories';

		$_categories = MaterialCategories::model()->findAll($criteria);
	...
	public function actionDelete($id)
	{
		...
		$model=new MaterialCategories('search');
//		header( 'Content-type: application/json' );
	...
	public function actionIndex()
	{
		...
		if(isset($_GET['MaterialCategories']))
			$model->attributes=$_GET['MaterialCategories'];

		if (Yii::app()->getRequest()->getIsAjaxRequest() &&
			(isset($_GET['ajax']) && $_GET['ajax']==='material-categories-grid')) {
//			header( 'Content-type: application/json' );
...
//			header( 'Content-type: application/json' );
	 ...
	 * @return MaterialCategories the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=MaterialCategories::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param MaterialCategories $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='material-categories-form')
		{
