...
class CollaboratingDepartmentsController extends Controller
{
	/**
...
//			header( 'Content-type: application/json' );
	 ...
	 * @return OtherDepartment the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=OtherDepartment::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param OtherDepartment $model the model to be validated
	 */
