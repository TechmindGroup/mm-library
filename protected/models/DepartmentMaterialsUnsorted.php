...
/**
 * This is the model class for table "department_materials_unsorted".
 *
 * The followings are the available columns in table 'department_materials_unsorted':
 * @property string $id
 ...
 * @property MaterialsUnsorted $material
 * @property MaterialQunits $quantityUnit
 * @property Departments $department
 */
class DepartmentMaterialsUnsorted extends CActiveRecord
{
	/**
	...
	{
		return 'department_materials_unsorted';
	}
	...
	public function rules()
	{
		...
		return array(
			...
			array('id, material_id, quantity, quantity_unit, department_id, create_timestamp', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'material' => array(self::BELONGS_TO, 'MaterialsUnsorted', 'material_id'),
	 ...
	 * @return DepartmentMaterialsUnsorted the static model class
	 */
